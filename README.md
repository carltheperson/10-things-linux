...
## 2. What is a shell? - [SeaShell](2_What_is_a_shell__SeaShell)
...
## 3. Ownership and permissions - [Tellaccess](3_Ownership_and_permissions__Tellaccess)
...
## 4. Grep - [Grep detective](4_Grep__Grep_detective)
...
## 5. Awk and sed - [Passwdinfo](5_Awk_and_sed__Passwdinfo)
...
## 6. Find - [Find treasure hunt](6_Find__Find_treasure_hunt)
...
## 7. File system - [Root tour](7_File_system__Root_tour)
...
## 8. Processes - [Stranger danger](8_Processes__Stranger_danger)
...
## 9. Systemd services - [Createservice](9_Systemd_services__Createservice)
...
## 10. Bash scripting - [Penguin cipher](10_Bash_scripting__Penguin_cipher)
